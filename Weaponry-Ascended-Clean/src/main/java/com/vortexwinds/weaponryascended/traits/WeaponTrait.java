...
public abstract class WeaponTrait {
    ...
    /**
     * Checks if this trait can trigger based on damage type
     */
    public boolean canTrigger(DamageSource damageSource) {
        return true; // Default allows all damage types
    }
    ...
    public enum TraitType {
        ELEMENTAL("elemental", "Adds elemental damage types"),
        PHYSICAL("physical", "Enhances physical weapon properties"),
        SPECIAL("special", "Provides special abilities and effects"),
        DEFENSIVE("defensive", "Provides defensive capabilities"),
        COMBO("combo", "Traits that trigger in combination with other effects");
